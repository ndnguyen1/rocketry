...
AirbrakeController::Config GAMMA_L2200 = {
    .targetApogee = 3048.0,  //
    .rocketMass = 10.8250,   //
    .minRocketCrossSectArea =
        0.0082,  // Gecko -> 0.0036 m^2 ; //Bluetongue -> 0.0082 m^2
    .maxRocketCrossSectArea =
        0.0082 + 0.004,         // Gecko -> 0.000484167 m^2  BT 0.004 m^2
    .controllerGain = -0.0045,  //
    .dragCoeffAreaGain = 0.00154959,
    .dragCoeffVelocityGain = -0.0006877,
    .dragCoeffAirDensityGain = 0.53186926,
    .dragCoeffIntercept = -0.0424235 + 0.3,
};
// DELTA CONFIG
// Delta L1365
